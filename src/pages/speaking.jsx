  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="课程报名"
          content="小王出品 - iOS开发课程（购前可微信zhaochunxiang1109咨询）"
        />
      </Head>
      <SimpleLayout
        title="小王出品 - iOS开发课程"
        ...
        <div className="space-y-20">
          ...
          <SpeakingSection title="SwfitUI-入门课">
            <Appearance
              ...
              title="小王SwiftUI入门课程 - 轻松入门"
              description="0基础。0计算机知识。完全小白的新手课。用生活中的字眼，解释编程世界中的“看似高大上的词汇”。纵观全网，最轻松的“单口相声版”《SwiftUI入门教程》，由讲课鬼才小王出品。"
              event="最新录制 2022 - 持续更新"
              cta="课程报名"
            />
            <Appearance
              href="https://www.bilibili.com/video/BV1dW4y1j7zG/"
              title="iOS开发新手课程路线图｜小王出品最新录制SwiftUI光速入门"
